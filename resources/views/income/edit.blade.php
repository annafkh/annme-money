...
<form action="{{ route('income.update', $income->id) }}" method="POST" class="space-y-4">
    ...
    <div class="space-y-4 bg-white p-6 rounded-2xl shadow-lg">
        ...
        <div>
            ...
            <input type="text" name="title" id="title" value="{{ old('title', $income->title) }}" 
        ...
        <div>
            ...
            <input type="text" name="amount" id="amount" value="{{ old('amount', number_format($income->amount, 0, ',', '.')) }}"
                   class="w-full p-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-400" required>
        </div>
        ...
        <div>
            ...
            <input type="date" name="date" id="date" value="{{ old('date', $income->date->toDateString()) }}" 
                   class="w-full p-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-400 cursor-pointer" required>
        </div>
